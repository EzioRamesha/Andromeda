...
namespace WebApp.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            ViewBag.UserProfile = UserService.Find(AuthUserId);
        ...
        public ActionResult ChangePassword(bool passwordExpired = false)
        {
            if (passwordExpired)
            {
                AddWarningMsg("Your password has expired. Please change your password");
                SetViewBagMessage();
            }
            return View();
        }
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            Result = UserService.UpdatePassword(User.Identity.GetUserId<int>(), model.OldPassword, model.NewPassword, ref trail);
            if (Result.Valid)
            {
                var user = await UserManager.FindByIdAsync(User.Identity.GetUserId<int>());
                if (user != null)

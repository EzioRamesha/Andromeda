...
{
    public class PerLifeSoaDataViewModel
    {
    }

    public class PerLifeSoaDataClaimViewModel
    {
        ...
        public static Expression<Func<PerLifeClaimRetroData, PerLifeSoaDataClaimViewModel>> Expression()
        {
            return entity => new PerLifeSoaDataClaimViewModel
            {
                Id = entity.Id,
                ...
                RetroSoaQuarter = entity.PerLifeClaimData.ClaimRegisterHistory.SoaQuarter,
        ...
        public static Expression<Func<PerLifeClaimRetroData, PerLifeSoaDataClaimViewModel>> RetroExpression()
        {
            return entity => new PerLifeSoaDataClaimViewModel
            {
                Id = entity.Id,
                ...
                RetroParty1 = entity.PerLifeClaimData.ClaimRegisterHistory.RetroParty1,
                RetroParty2 = entity.PerLifeClaimData.ClaimRegisterHistory.RetroParty2,
                RetroParty3 = entity.PerLifeClaimData.ClaimRegisterHistory.RetroParty3,
                ClaimRecoveryAmt = entity.PerLifeClaimData.ClaimRegisterHistory.ClaimRecoveryAmt,
            };
        }
    }

    public class PerLifeSoaDataRetroOutputViewModel
    {
        public int Id { get; set; }
        ...
        public static Expression<Func<PerLifeAggregationMonthlyData, PerLifeSoaDataRetroOutputViewModel>> Expression()
        {
            return entity => new PerLifeSoaDataRetroOutputViewModel
            {
                Id = entity.Id,
                ...
                CurrencyRate = entity.PerLifeAggregationDetailData.RiDataWarehouseHistory.CurrencyRate,

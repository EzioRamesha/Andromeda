var app = new Vue({
    el: '#app',
    data: {
        TreatyPricingDefinitionAndExclusion: Model,
        TreatyPricingDefinitionAndExclusionVersion: Model.CurrentVersionObject,
        //Product
    ...
    methods: {
        ...
        resetRemarkInfo: function () {
            ...
            this.RemarkModal.ModuleId = this.TreatyPricingDefinitionAndExclusion.ModuleId;
            this.RemarkModal.ObjectId = this.TreatyPricingDefinitionAndExclusion.TreatyPricingCedantId;
            this.RemarkModal.SubModuleController = SubModuleController;
            this.RemarkModal.SubObjectId = this.TreatyPricingDefinitionAndExclusion.Id;
        ...
        saveDocuments(remarkIndex, remarkId = null) {
            ...
            var parentId = this.TreatyPricingDefinitionAndExclusion.TreatyPricingCedantId;
            var document = {
                ModuleId: this.TreatyPricingDefinitionAndExclusion.ModuleId,
                ObjectId: parentId,
                SubModuleController: SubModuleController,
                SubObjectId: this.TreatyPricingDefinitionAndExclusion.Id,
                RemarkId: remarkId,

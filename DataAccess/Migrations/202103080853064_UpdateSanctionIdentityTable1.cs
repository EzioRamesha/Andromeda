namespace DataAccess.Migrations
{
    ...
    public partial class UpdateSanctionIdentityTable1 : DbMigration
    {
        ...
        public override void Down()
        {
            DropIndex("dbo.SanctionIdentities", new[] { "IdNumber" });
            DropIndex("dbo.SanctionIdentities", new[] { "IdType" });
            AlterColumn("dbo.SanctionIdentities", "IdNumber", c => c.String(nullable: false, maxLength: 30));
            AlterColumn("dbo.SanctionIdentities", "IdType", c => c.String(nullable: false, maxLength: 30));
            CreateIndex("dbo.SanctionIdentities", "IdNumber");
            CreateIndex("dbo.SanctionIdentities", "IdType");
        }
    }

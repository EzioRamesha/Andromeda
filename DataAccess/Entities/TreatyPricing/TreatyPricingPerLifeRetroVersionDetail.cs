...
{
    [Table("TreatyPricingPerLifeRetroVersionDetails")]
    public class TreatyPricingPerLifeRetroVersionDetail
    {
        [Key]
        ...
        public TreatyPricingPerLifeRetroVersionDetail()
        {
        ...
        public static bool IsExists(int id)
        {
            ...
            {
                return db.TreatyPricingPerLifeRetroVersionDetails.Any(q => q.Id == id);
            }
        }

        public static TreatyPricingPerLifeRetroVersionDetail Find(int? id)
        {
            using (var db = new AppDbContext())
            {
                return db.TreatyPricingPerLifeRetroVersionDetails.Where(q => q.Id == id).FirstOrDefault();
            }
        }
        ...
        public DataTrail Create()
        {
            using (var db = new AppDbContext())
            {
                db.TreatyPricingPerLifeRetroVersionDetails.Add(this);
                db.SaveChanges();
        ...
        public static DataTrail Delete(int id)
        {
            using (var db = new AppDbContext())
            {
                var entity = db.TreatyPricingPerLifeRetroVersionDetails.Where(q => q.Id == id).FirstOrDefault();
                if (entity == null)
                {
                    throw new Exception(MessageBag.NoRecordFound);
                }
                ...
                db.TreatyPricingPerLifeRetroVersionDetails.Remove(entity);
                db.SaveChanges();

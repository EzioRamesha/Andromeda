...
{
    [Table("TreatyPricingFinancialTableVersionDetails")]
    public class TreatyPricingFinancialTableVersionDetail
    {
        [Key]
        ...
        public TreatyPricingFinancialTableVersionDetail()
        {
        ...
        public static bool IsExists(int id)
        {
            ...
            {
                return db.TreatyPricingFinancialTableVersionDetails.Any(q => q.Id == id);
            }
        }

        public static TreatyPricingFinancialTableVersionDetail Find(int id)
        {
            using (var db = new AppDbContext())
            {
                return db.TreatyPricingFinancialTableVersionDetails.Where(q => q.Id == id).FirstOrDefault();
            }
        }
        ...
        public DataTrail Create()
        {
            using (var db = new AppDbContext())
            {
                db.TreatyPricingFinancialTableVersionDetails.Add(this);
                db.SaveChanges();
        ...
        public static DataTrail Delete(int id)
        {
            using (var db = new AppDbContext())
            {
                ...
                db.TreatyPricingFinancialTableVersionDetails.Remove(entity);
                db.SaveChanges();
        ...
        public static IList<DataTrail> DeleteAllByTreatyPricingFinancialTableVersionId(int treatyPricingFinancialTableVersionId)
        {
            using (var db = new AppDbContext())
            {
                var query = db.TreatyPricingFinancialTableVersionDetails.Where(q => q.TreatyPricingFinancialTableVersionId == treatyPricingFinancialTableVersionId);

                List<DataTrail> trails = new List<DataTrail>();
                foreach (TreatyPricingFinancialTableVersionDetail entity in query.ToList())
                {
                    DataTrail trail = new DataTrail(entity, true);
                    trails.Add(trail);

...
namespace ConsoleApp.Commands.RawFiles.RiData
{
    public class LogRiDataFile
    {
        ...
        public Stopwatch SwPreComputation1 { get; set; } = new Stopwatch();
        public Stopwatch SwPreComputation2 { get; set; } = new Stopwatch();
        public Stopwatch SwTreatyMapping { get; set; } = new Stopwatch();
        public Stopwatch SwTreatyNumberTreatyTypeMapping { get; set; } = new Stopwatch();
        public Stopwatch SwBenefitMapping { get; set; } = new Stopwatch();
        public Stopwatch SwProductFeatureMapping { get; set; } = new Stopwatch();
        public Stopwatch SwCellMapping { get; set; } = new Stopwatch();
        public Stopwatch SwRateTableMapping { get; set; } = new Stopwatch();
        public Stopwatch SwAnnuityFactorMapping { get; set; } = new Stopwatch();
        public Stopwatch SwRiDataLookup { get; set; } = new Stopwatch();
        public Stopwatch SwRiskDate { get; set; } = new Stopwatch();
        public Stopwatch SwFacMapping { get; set; } = new Stopwatch();
        public Stopwatch SwPreValidation { get; set; } = new Stopwatch();
        public Stopwatch SwPostComputation { get; set; } = new Stopwatch();
        ...
        public TimeSpan TsPreComputation1 { get; set; }
        public TimeSpan TsPreComputation2 { get; set; }
        public TimeSpan TsTreatyMapping { get; set; }
        public TimeSpan TsTreatyNumberTreatyTypeMapping { get; set; }
        public TimeSpan TsBenefitMapping { get; set; }
        public TimeSpan TsProductFeatureMapping { get; set; }
        public TimeSpan TsCellMapping { get; set; }
        public TimeSpan TsRateTableMapping { get; set; }
        public TimeSpan TsAnnuityFactorMapping { get; set; }
        public TimeSpan TsRiDataLookup { get; set; }
        public TimeSpan TsRiskDate { get; set; }
        public TimeSpan TsFacMapping { get; set; }
        public TimeSpan TsPreValidation { get; set; }
        public TimeSpan TsPostComputation { get; set; }
        public TimeSpan TsPostValidation { get; set; }

        public LogRiDataFile(RiDataFileBo file)
        {
            RiDataFileBo = file;
        }
        ...
        public void AddCount(LogRiDataFile file)
        {
        ...
        public void AddElapsedDetails(LogRiDataFile file)
        {
        ...
        {
            return MappingErrorCount +
                PreComputation1ErrorCount +
                PreComputation2ErrorCount +
                PreValidationErrorCount +
                PostComputationErrorCount +
                PostValidationErrorCount;
        }

        public int GetMappingErrorCount()
        {
            return MappingErrorCount;
        }

        public int GetPreComputation1ErrorCount()
        {
            return PreComputation1ErrorCount;
        }

        public int GetPreComputation2ErrorCount()
        {
            return PreComputation2ErrorCount;
        }

        public int GetPreValidationErrorCount()
        {
            return PreValidationErrorCount;
        }

        public int GetPostComputationErrorCount()
        {
            return PostComputationErrorCount;
        }

        public int GetPostValidationErrorCount()
        {
            return PostValidationErrorCount;
        }

        public string GetTotalRiData()
        {
            int w = GetWidth();
            return string.Format("{0}: {1}", "Total number of RI Data".PadRight(w, ' '), RiDataCount);
        }
        ...
        public List<string> GetInfo()
        {
            ...
            var list = new List<string>
            {
                ...
                string.Format("{0}: {1}", "RI Data Batch ID".PadRight(w, ' '), RiDataFileBo.RiDataBatchId),
                string.Format("{0}: {1}", "RI Data File ID".PadRight(w, ' '), RiDataFileBo.Id),
                string.Format("{0}: {1}", "File Name".PadRight(w, ' '), RiDataFileBo.RawFileBo.FileName),
                string.Format("{0}: {1}", "Excluded".PadRight(w, ' '), RiDataFileBo.Mode == RiDataFileBo.ModeExclude ? "YES" : "NO"),
        ...
        public List<string> GetCount()
        {
            ...
            return new List<string>
            {
                ...
                string.Format("{0}: {1}", "  Total MFRS17 Contract Code mapping error".PadRight(w, ' '), CellMfrs17TreatyCodeMappingErrorCount),
        ...
        public TimeSpan GetTotalElapsedTimeDetails()
        {
            ...
            ts = ts.Add(TsPreComputation1);
            ts = ts.Add(TsPreComputation2);
            ts = ts.Add(TsTreatyMapping);
            ts = ts.Add(TsTreatyNumberTreatyTypeMapping);
            ts = ts.Add(TsBenefitMapping);
            ts = ts.Add(TsProductFeatureMapping);
            ts = ts.Add(TsCellMapping);
            ts = ts.Add(TsRateTableMapping);
            ts = ts.Add(TsAnnuityFactorMapping);
            ts = ts.Add(TsRiDataLookup);
            ts = ts.Add(TsRiskDate);
            ts = ts.Add(TsFacMapping);
            ts = ts.Add(TsPreValidation);
            ts = ts.Add(TsPostComputation);

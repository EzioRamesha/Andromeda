...
{
    public class ProcessRetroStatement : Command
    {
        ...
        public ProcessRetroStatement()
        {
            Title = "ProcessRetroStatement";
        ...
        public RetroStatementBo Process()
        {
            ...
            string partyName = retroParty.Party.Replace(" ", "").ToLower();

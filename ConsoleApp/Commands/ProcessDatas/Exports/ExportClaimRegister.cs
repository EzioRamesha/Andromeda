...
{
    class ExportClaimRegister : ExportFile
    {
        public ClaimRegisterBo ClaimRegisterBo { get; set; }
        public IQueryable<ClaimRegisterBo> Query { get; set; }
        public override string PrefixFileName { get; set; } = "ClaimRegister";
            ...
            switch (col.Property)
            {
                ...
                case "TreatyCode":
                    if (col.Header == "BUSINESS ORIGIN")
                        return TreatyCodeService.GetBusinessOriginByCode(v.ToString());

...
{
    public class TreatyPricingRateTableRateBo
    {
        ...
        public static TreatyPricingRateTableRateBo Clone(TreatyPricingRateTableRateBo bo = null)
        {
            if (bo == null)
        ...
        public void SetDefaultRate(TreatyPricingRateTableRateBo currentRateBo)
        {
            MaleNonSmoker = 0;
            MaleSmoker = 0;
            FemaleNonSmoker = 0;
        ...
        public void ConvertRateToANxB(string ageBasis, TreatyPricingRateTableRateBo previousRateBo, TreatyPricingRateTableRateBo currentRateBo)
        {
        ...
        public void ConvertSmokerAggregatedRate()
        {
            ...
            //    Male = (MaleNonSmoker + MaleSmoker) / 2;

            //if (!Female.HasValue && (FemaleNonSmoker.HasValue || FemaleSmoker.HasValue))
            //    Female = (FemaleNonSmoker + FemaleSmoker) / 2;

            //if (!Unisex.HasValue && (Male.HasValue || Female.HasValue))
            //    Unisex = (Male + Female) / 2;

            // 2021-09-22 formula (latest)
            //Male = 70 % x MNS Rate +30 % x MS Rate
            //Female = 87 % x FNS Rate +13 % x FS Rate
            //Unisex = 70 % x Male Rate +30 % x Female Rate

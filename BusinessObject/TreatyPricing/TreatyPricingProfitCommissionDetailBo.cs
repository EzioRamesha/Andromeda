...
{
    public class TreatyPricingProfitCommissionDetailBo
    {
        ...
        public static List<TreatyPricingProfitCommissionDetailBo> GetDefaultRow(int parentId)
        {
            return new List<TreatyPricingProfitCommissionDetailBo> {
                // Income
                new TreatyPricingProfitCommissionDetailBo
                {

...
{
    public class TreatyPricingDefinitionAndExclusionBo : ObjectVersion
    {
        ...
        public int? DuplicateTreatyPricingDefinitionAndExclusionId { get; set; }
        public int? DuplicateTreatyPricingDefinitionAndExclusionVersionId { get; set; }
        public bool DuplicateFromList { get; set; } = false;

        public IList<TreatyPricingDefinitionAndExclusionVersionBo> TreatyPricingDefinitionAndExclusionVersionBos { get; set; }

...
{
    public class ClaimDataConfigBo
    {
        [JsonIgnore]
        ...
        public IList<ClaimDataMappingBo> ClaimDataMappingBos { get; set; }

        public IList<ClaimDataComputationBo> ClaimDataComputationBos { get; set; }

        public IList<ClaimDataValidationBo> ClaimDataValidationBos { get; set; }
